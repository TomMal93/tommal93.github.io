...
<img src="https://cdn-images-1.medium.com/max/2000/1*pWGJIKats-zuumA3RQNEWQ.jpeg" alt="">
...
{% include elements/figure.html image="/../assets/images/Struktura projektu WASM.png" caption="Several years ago we were definitely in the room on the right but we’ve moved a lot closer to the room on the left." %}
{% include elements/figure.html image="..\assets\images\Struktura projektu WASM.png" caption="Several years ago we were definitely in the room on the right but we’ve moved a lot closer to the room on the left." %}
{% include elements/figure.html image="\..\assets\images\Struktura projektu WASM.png" caption="Several years ago we were definitely in the room on the right but we’ve moved a lot closer to the room on the left." %}


<img src="/../assets/images/Struktura projektu WASM.png" alt="">
<img src="../assets/images/Struktura projektu WASM.png" alt="">
