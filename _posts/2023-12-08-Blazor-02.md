...
<table>
  ...
  <tr>
    <td style="border: none;">Lokalizacja modeli to folder: "Data"</td>
    <td style="border: none;">Lokalizacja modeli to projekt: "Blazor.WebAssembly.Shared"</td>
  </tr>
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3"><strong>Serwisy/Kontrolery</strong></th>
  </tr>
  <tr>
    <td style="border: none;">Serwisy znajdują się również jak modele w folderze: "Data"</td>
    <td style="border: none;">Kontrolery znajdująsię w projekcie Blazor.WebAssembly.Server w folderze: "Controllers"</td>
  </tr>
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3"><strong>Początkowy punkt aplikacji</strong></th>
  </tr>
  <tr>
    <td style="border: none;">Początkowy punkt aplikacji to plik: "_Host.cshtml"</td>
    <td style="border: none;">Początkowy punkt aplikacji to plik: "/wwwroot/index.html"</td>
  </tr>
  <tr>
