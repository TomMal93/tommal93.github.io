---
title: Przerabiamy Blazora - PART II
tags: [Programowanie, Blazor]
style: fill
color: info 
description: Drugi krok - przedstawiamy definicje oraz podejścia korzystania z tej technologii.
---
<hr >
...
<figure class="figure">
    <img src="..\assets\images\art-2\blazor-power.png" class="figure-img img-fluid article_image--container container-glow" alt="">
    <figcaption class="figure-caption text-center">Blazor w pełnej krasie</figcaption>
</figure>
<hr>
...
Framework Blazor dzieli się na dwa główne typy - Server-Side oraz WebAssembly.<br>
...
<hr >
<figure class="figure">
    <img src="..\assets\images\art-2\studying.png" class="figure-img img-fluid article_image--container container-glow" alt="">
    <figcaption class="figure-caption text-center">Ucz się!</figcaption>
</figure>
...
Struktura WebAssembly jest podzielona na trzy projekty: Client, Server i Shared. <br>
Client zawiera strony i wwwroot, podczas gdy Server ma kontrolery, co podkreśla jego rolę w obsłudze żądań HTTP.<br> 
Projekt Shared jest wspólny dla obu i zazwyczaj dotyczy wspólnych modeli lub danych.<br>
...
<div class="article_two_images_inline--container container-glow" >
    <figure class="figure">
        <img src="..\assets\images\art-2\Struktura projektu Server Side.PNG" class="figure-img img-fluid rounded" alt="">
        <figcaption class="figure-caption text-center">Server-Side</figcaption>
    </figure>
    <figure class="figure">
        <img src="..\assets\images\art-2\Struktura projektu WASM.PNG" class="figure-img img-fluid rounded" alt="">
...
<table class="article_table--container container-glow-green">
  <tr>
    <th style="text-align: center;"><strong>Elementy wspólne</strong></th>
  </tr>
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Folder: Properties</strong></th>
  </tr>
  <tr>
  ...
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Folder: wwwroot</strong></th>
  </tr>
  <tr>
    <td >Zawiera statyczne zasoby projektu, takie jak HTML, CSS, JavaScript, obrazy itd.</td>
  </tr>
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Folder: Data</strong></th>
  </tr>
  <tr>
    <td >Zawiera klasy i plików związane z danymi i logiką biznesową.</td>
  </tr>
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Folder: Pages</strong></th>
  </tr>
  <tr>
    <td >Zawiera komponenty Razor dla poszczególnych stron aplikacji.</td>
  </tr>
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Folder: Shared</strong></th>
  </tr>
  <tr>
    <td >Zawiera komponenty współdzielone, takie jak layouty i nawigacja.</td>
  </tr>
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Plik: _Imports.razor</strong></th>
  </tr>
  <tr>
    <td >W obu projektach wykorzystuje się go do globalnego importowania usingów.</td>
  </tr>
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Plik: App.razor</strong></th>
  </tr>
  <tr>
    <td >Główny komponent aplikacji, definiujący routing i jej zachowania na najwyższym poziomie.</td>
  </tr>
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Plik: appsettings.json</strong></th>
  </tr>
  <tr>
  ...
  <tr>
    <th style="text-align: center; background-color:#0056b3; "><strong>Plik: Program.cs</strong></th>
  </tr>
  <tr>
...
Wspólne punkty zostały omówione, więc przejdziemy teraz do głównych różnic obu podejść.

<table class="article_table--container container-glow-red">
  <tr>
    <th colspan="2" style="text-align: center;"><strong>Różnice</strong></th>
  </tr>
  <tr>
    <th style="text-align: center;  width:50%;">Server-Side</th>
    <th style="text-align: center;  width:50%;">WebAssembly</th>
  ...
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3; ">Modele</th>
  </tr>
  <tr>
  ...
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3; ">Serwisy/Kontrolery</th>
  </tr>
  <tr>
  ...
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3; ">Początkowy punkt aplikacji</th>
  </tr>
  <tr>
  ...
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3; ">Plik _Layout.cshtml</th>
  </tr>
  <tr>
  ...
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3; ">Plik blazor.webassembly.js</th>
  </tr>
  <tr>
  ...
  <tr>
    <th colspan="2" style="text-align: center; background-color:#0056b3; ">Folder Controllers</th>
  </tr>
  <tr>
...
<hr>
Podsumowując, Blazor oferuje nowoczesne podejście do tworzenia interaktywnych aplikacji webowych, wykorzystując zalety .NET i C#. 
Zarówno Blazor Server-Side, jak i WebAssembly mają swoje miejsce w arsenale dewelopera, każdy z nich nadaje się do różnych scenariuszy użycia. 
Wybór między nimi powinien być podyktowany specyficznymi wymaganiami projektu i preferencjami w zakresie wydajności oraz architektury. 

Dzięki temu wprowadzeniu, mam nadzieję, że poczujesz się zachęcony do dalszego eksplorowania i wykorzystywania Blazor w swoich projektach. 
Zapraszam do dalszego zgłębiania tematu i eksperymentowania z Blazor. 
